...
def ip_config_emissor(mensagem_codificada_nrz,mensagem_codificada_rz,host_ip,port):
    ...
    # enconde é usado para converter uma string em uma sequencia de bytes, 
...
class Ui_MainWindow(object):
    ...
    def send_button_clicked(self):
        ...
        if not host_ip or not port:
            QMessageBox.warning(MainWindow, "Atenção", "Preencha o IP e a porta antes de enviar.")
            return

        # # # Verifica se os sinais foram carregados
        # if not self.mensagem_codificada_nrz or not self.mensagem_codificada_rz:
        #     QMessageBox.warning(MainWindow, "Atenção", "Carregue os sinais antes de enviar.")
        #     return


        # Envia os sinais para o receptor
