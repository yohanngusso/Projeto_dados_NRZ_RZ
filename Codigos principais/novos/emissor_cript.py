...
def about(message):
    ...
    return message, mensagem_criptografada, key, mensagem_binaria, mensagem_codificada_nrz, mensagem_codificada_rz, mensagem_codificada_nrzI
...
class OutputWindow(QtWidgets.QMainWindow):
    def __init__(self, message,mensagem_criptografada, key, binary_message, nrz_signal, rz_signal,nrzi_signal):
...
class Ui_MainWindow(object):
    ...
    def plot_button_clicked(self):
        ...
        message, mensagem_criptografada,key, mensagem_binaria, mensagem_codificada_nrz,mensagem_codificada_rz,mensagem_codificada_nrzI = about(message)
    ...
    def load_button_clicked(self):
        ...
        message,  mensagem_criptografada,key, binary_message, mensagem_codificada_nrz, mensagem_codificada_rz,mensagem_codificada_nrzI = about(message)

        self.output_window =  OutputWindow(message,  mensagem_criptografada, key, binary_message, mensagem_codificada_nrz, mensagem_codificada_rz,mensagem_codificada_nrzI)
    ...
    def send_button_clicked(self):
        ...
        message, mensagem_criptografada,key, binary_message, mensagem_codificada_nrz, mensagem_codificada_rz,mensagem_codificada_nrzI = about(message)
        ip_config_emissor(mensagem_codificada_nrz, mensagem_codificada_rz,mensagem_codificada_nrzI, host_ip, int(port))

        QMessageBox.information(MainWindow, "Sucesso", "Mensagem enviada com sucesso.")

        self.output_window = OutputWindow(message,key, mensagem_criptografada, binary_message, mensagem_codificada_nrz, mensagem_codificada_rz, mensagem_codificada_nrzI)
        self.output_window.show()
